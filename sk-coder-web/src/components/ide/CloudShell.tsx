      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0, position: "relative" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", padding: "0.4rem 0.75rem", background: "var(--bg-sidebar)", borderBottom: "1px solid var(--border)", fontSize: 12 }}>
          <button
            ...
            onClick={() => { setIframeUrl(null); if (iframeTimerRef.current) clearTimeout(iframeTimerRef.current) }}
          >
            ← Back
          </button>
        ...
        <iframe
          ...
          onLoad={() => { if (iframeTimerRef.current) clearTimeout(iframeTimerRef.current) }}
