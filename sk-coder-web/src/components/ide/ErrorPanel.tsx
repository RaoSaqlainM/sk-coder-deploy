  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {counts.error > 0 && (
          <span style={{ display: "flex", alignItems: "center", gap: 3, color: "#f38ba8" }}>
        ...
        {counts.warning > 0 && (
          <span style={{ display: "flex", alignItems: "center", gap: 3, color: "#fab387" }}>
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button
          onClick={() => setErrors([])}
          style={{ background: "none", border: "none", cursor: "pointer", color: "var(--text-muted)", padding: "0 0.25rem", fontSize: 12 }}
          title="Clear"
        >
          ✕
        </button>
