...
export default function TopBar() {
    const { isRunning, setIsRunning, fileTree, activePanel, sidebarOpen, setActivePanel, setShowSettings, getActiveFile, setPreviewContent, setPreviewPath, setErrors, setPreviewResult, } = useIDEStore();
