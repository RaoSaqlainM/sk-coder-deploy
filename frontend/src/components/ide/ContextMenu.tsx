...
export default function ContextMenu() {
    const { contextMenu, setContextMenu, deleteNode, setRenameNodeId, setNewItem, openTab, fileTree, setActivePanel, addTerminalLine, setTerminalInput, refreshPreview, setPreviewContent, clearTerminal, getActiveFile, settings, openInTerminal, openFileInTerminal, setFileTree, moveNode, setSidebarOpen, setPreviewResult, setSelectionMode, toggleSelectedPath, setIsRunning, setPreviewPath, } = useIDEStore();
